...
<div class="col-sm-9">
	<h1>Sales Bill</h1>
      ...
      <div class="well">
<form  class="form-horizontal" action="<?php echo site_url('SaleBillController/store'); ?>" method="POST">
  <div class="form-group">
    ...
    <select  class="form-control" name="product_id" id="product_id" required>
		...
		<div class="form-group">
    <label for="seller_id">Customer:</label>
...
<div class="form-group">
    ...
    <button type="submit" class="btn btn-primary">Create Sales Bill</button>
	</div>
</form>
<div class="row">
        <div class="col-sm-12">
...
<table class="table table-bordered">
    ...
    <tbody>
        <?php 
		if(empty($sale_billes)){ echo "<tr><th colspan='4' class='text-center'>Data Not Found</th></tr>"; };
		foreach ($sale_billes as $index => $item): ?>
            <tr>
